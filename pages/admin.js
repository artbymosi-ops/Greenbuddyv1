...
const s = {
  ...
  title: { marginBottom: 12, fontSize: 24, fontWeight: 800 },
  label: { fontSize: 13, marginTop: 8, marginBottom: 4, color: "#b8d3c9" },
  input: { width: "100%", borderRadius: 10, border: "1px solid #1f2a27", background: "#0b0f0e", color: "#eaf6f1", padding: "10px 12px", marginBottom: 8 },
  btn: { marginTop: 8, background: "#a9f5d0", color: "#0b0f0e", border: "none", borderRadius: 10, padding: "10px 14px", fontWeight: 700, cursor: "pointer" },
  err: { marginTop: 4, color: "#ffb0b0" },
};
